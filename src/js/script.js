...

{
  ...
  class Cart {
    ...
    getElements(element) {
      ...
      thisCart.dom.address = thisCart.wrapper.querySelector(select.cart.address);
      thisCart.dom.phone = thisCart.wrapper.querySelector(select.cart.phone);
...
class CartProduct {
  ...
  /* metoda,która zwraca wszystkie informacje z CartProduct o zamawianym produkcie */
  getData() {
    const thisCartProduct = this;
    const data = {
